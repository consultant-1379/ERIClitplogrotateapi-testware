...
public class LITPlogrotateapiTestRunner extends TorTestCaseHelper {
    
    Logger logger = Logger.getLogger(LITPlogrotateapiTestRunner.class);
    ...
    @TestId(id = "CXP9031122-1", title = "Upgrade ERIClitplogrotateapi rpm on the MS")
    @Test(groups={"ACCEPTANCE"})
    public void upgradeERIClitplogrotateapiRPM() throws TimeoutException, FileNotFoundException {

        rpmUpgradeOperator.initialise("logrotateapi");
     ...
     * @PRIORITY HIGH
     */
    @TestId(id = "CXP9031122-2", title = "Run python test cases for ERIClitplogrotateapi package")
    @Test(groups={"CDB_REGRESSION", "ACCEPTANCE"})
    public void runERIClitplogrotateapiTests() {
     ...
     * @PRE Execution of test {@link #runERIClitplogrotateapiTests()}
     * @PRIORITY HIGH
     * @param className
     * @param name
     * @param failures
     */
    @TestId(id = "CXP9031122-3", title = "Parse xml outputs from python tests")
